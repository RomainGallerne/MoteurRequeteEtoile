package qengine_PLEV.QueryCounter;
...
public class QueryResponseCounter {
    ...
    public static void main(String[] args) {
        ...
        RDFHexaStore_PLEV storeWith500K = new RDFHexaStore_PLEV();
        ...
        RDFHexaStore_PLEV storeWith2M = new RDFHexaStore_PLEV();
     ...
     */
    private static void loadRDFData(String rdfFilePath, RDFHexaStore_PLEV store) {
        try {
     ...
     * @param store       Instance du RDFHexaStore
     */
    private static void calculateQueryResponses(String querySetDir, RDFHexaStore_PLEV store, String outputFilePath) {
